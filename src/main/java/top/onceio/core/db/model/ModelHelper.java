...
public class ModelHelper implements DDLDao, TransDao {
    ...
    public ModelHelper(JdbcHelper jdbcHelper, IdGenerator idGenerator, List<Class<? extends OEntity>> entitys) {
        super();
    ...
    public <E extends OEntity> E get(Class<E> tbl, Long id) {
        BaseTable<E> cnd = new BaseTable<E>(null);
    ...
    public <E extends OEntity> int updateByTpl(Class<E> tbl, BaseTable<E> tpl) {
        return 0;
    }
    ...
    public <E extends OEntity> int delete(Class<E> tbl, BaseTable<E> cnd) {
        if (cnd == null)
            return 0;
        TableMeta tm = classToTableMeta.get(tbl);
    ...
    public <E extends OEntity> long count(Class<E> tbl, BaseTable<E> cnd) {
        return 0;
    }

    public <E extends OEntity> Page<E> find(Class<E> tbl, BaseTable<E> cnd) {
        return new Page<>();
    }

    public <E extends OEntity> E fetch(Class<E> tbl, BaseTable<E> cnd) {
        return null;
    }

    public <E extends OEntity> void find(Class<E> tbl, BaseTable<E> cnd, Consumer<E> consumer) {
        TableMeta tm = classToTableMeta.get(tbl);
        if (tm == null) {
            return;
        }
